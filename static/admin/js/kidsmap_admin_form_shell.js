/* ==========================================================================
   KidsMap admin — legacy form shell behaviour.

   The pre-redesign place-form script, kept because five other admin change
   forms still rely on it (accordion sections, admin fieldset label fixups,
   error summary focus). The place form itself is driven by
   kidsmap_place_form.js and kidsmap_place_media.js.

   Every block guards on its own selectors, so it is inert on pages that do not
   use the legacy markup.

   TECHNICAL DEBT: to be retired together with kidsmap_admin_form_shell.css.
   ========================================================================== */
