...
urlpatterns = [
    ...
    path("account/deletion/", account_deletion_request, name="account_deletion_request"),
    path(
        "account/deletion/<uuid:subject_reference>/confirm/",
        account_deletion_confirm,
        name="account_deletion_confirm",
    ),
    path(
        "account/deletion/<uuid:subject_reference>/cancel/",
        account_deletion_cancel,
        name="account_deletion_cancel",
    ),
    path(
        "account/deletion/<uuid:subject_reference>/status/",
        account_deletion_status,
