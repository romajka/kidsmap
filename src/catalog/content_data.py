...
SEO_LANDING_PAGE_COPY = {
    ...
    "dzudo-dlya-detey-v-baku": {
        "title": "Дзюдо для детей в Баку",
        "meta_description": "Секции дзюдо для детей в Баку: реальные цены, районы, метро, возраст и расписание. Сравните опубликованные карточки на KidsMap.",
        "intro": "Сравните опубликованные секции дзюдо в Баку по району, метро, возрасту, стоимости и расписанию. Данные ниже автоматически собираются из актуальных карточек KidsMap.",
        "benefits": [
            "Только реальные опубликованные карточки",
            "Сравнение возраста, цен и расписания",
            "Прямые ссылки на секции без посредников",
        ],
        "catalog_query": "?q=judo&district=baku",
        "comparison_key": "judo",
        "faq": [
            ("С какого возраста можно заниматься дзюдо?", "Возрастные ограничения зависят от секции. Сравните фактические диапазоны в таблице и уточните наличие места в выбранной группе."),
            ("Сколько стоят занятия дзюдо в Баку?", "На странице показаны только цены из опубликованных карточек. Если секция не указала сопоставимый диапазон, это отмечено отдельно."),
        ],
    },
    ...
    "az": {
        ...
        "dzudo-dlya-detey-v-baku": {"title": "Bakıda uşaqlar üçün cüdo", "meta_description": "Bakıda uşaqlar üçün cüdo bölmələri: real qiymətlər, rayonlar, metro, yaş və məşq cədvəli. KidsMap-da dərc olunmuş kartları müqayisə edin.", "intro": "Bakıda dərc olunmuş cüdo bölmələrini rayon, metro, yaş, qiymət və cədvələ görə müqayisə edin. Aşağıdakı məlumatlar KidsMap kartlarından avtomatik toplanır.", "benefits": ["Yalnız real dərc olunmuş kartlar", "Yaş, qiymət və cədvəlin müqayisəsi", "Vasitəçisiz bölmə kartlarına birbaşa keçid"], "catalog_query": "?q=judo&district=baku", "comparison_key": "judo", "faq": [("Uşaq neçə yaşdan cüdo ilə məşğul ola bilər?", "Yaş hədləri bölmədən asılıdır. Cədvəldəki real yaş aralıqlarını müqayisə edin və seçdiyiniz qrupda yer olub-olmadığını dəqiqləşdirin."), ("Bakıda cüdo məşqləri neçəyədir?", "Səhifədə yalnız dərc olunmuş kartlarda olan qiymətlər göstərilir. Bölmə müqayisə edilən qiymət aralığını yazmayıbsa, bu ayrıca qeyd olunur.")]},
    ...
    "en": {
        ...
        "dzudo-dlya-detey-v-baku": {"title": "Judo for children in Baku", "meta_description": "Judo clubs for children in Baku with real prices, districts, nearby metro stations, ages and schedules. Compare published KidsMap listings.", "intro": "Compare published judo clubs in Baku by district, metro, age, price and schedule. The data below is aggregated automatically from current KidsMap listings.", "benefits": ["Only real published listings", "Compare ages, prices and schedules", "Direct links to club listings without intermediaries"], "catalog_query": "?q=judo&district=baku", "comparison_key": "judo", "faq": [("What age can children start judo?", "Age limits vary by club. Compare the actual ranges in the table and confirm availability in the relevant group."), ("How much do judo classes cost in Baku?", "The page shows only prices supplied in published listings. If a club has not provided a comparable range, this is marked clearly.")]},
