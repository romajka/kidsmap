...
CATEGORIES = [
    ...
    {"code": "water-leisure", "ru": "Водный отдых", "az": "Su istirahəti", "en": "Water leisure", "icon": "icons/categories/water-leisure.svg", "bg": "#DBEAFE", "text": "#2563EB"},
    {"code": "parks-playgrounds", "ru": "Парки и детские площадки", "az": "Parklar və uşaq meydançaları", "en": "Parks & playgrounds", "icon": "icons/categories/parks-playgrounds.svg", "bg": "#E8F5EE", "text": "#0C7A47"},
    {"code": "FUN", "ru": "Развлечения и досуг", "az": "Əyləncə və asudə vaxt", "en": "Entertainment & leisure", "icon": "icons/categories/fun.svg", "bg": "#FFEDD5", "text": "#C2410C"},
    {"code": "ZOO", "ru": "Зоопарки", "az": "Zooparklar", "en": "Zoos", "icon": "icons/categories/zoo.svg", "bg": "#ECFCCB", "text": "#4D7C0F"},
    {"code": "museums-culture", "ru": "Музеи и культура", "az": "Muzeylər və mədəniyyət", "en": "Museums & culture", "icon": "icons/categories/museums-culture.svg", "bg": "#FEF3C7", "text": "#A16207"},
    {"code": "dance", "ru": "Танцы", "az": "Rəqslər", "en": "Dance", "icon": "icons/categories/dance.svg", "bg": "#FFE4E6", "text": "#E11D48"},
    {"code": "EDU", "ru": "Образование", "az": "Təhsil", "en": "Education", "icon": "icons/categories/education.svg", "bg": "#E0E7FF", "text": "#4338CA"},
    ...
    {"code": "ART", "ru": "Творчество", "az": "Yaradıcılıq", "en": "Creativity", "icon": "icons/categories/art.svg", "bg": "#FCE7F3", "text": "#BE185D"},
    {"code": "theater-stage", "ru": "Театр и сцена", "az": "Teatr və səhnə", "en": "Theater & stage", "icon": "icons/categories/theater-stage.svg", "bg": "#FCE7F3", "text": "#9D174D"},
    {"code": "MUS", "ru": "Музыка", "az": "Musiqi", "en": "Music", "icon": "icons/categories/music.svg", "bg": "#FAE8FF", "text": "#A21CAF"},
    {"code": "intellect-skills", "ru": "Интеллект и навыки", "az": "İntellekt və bacarıqlar", "en": "Intellect & skills", "icon": "icons/categories/intellect-skills.svg", "bg": "#FEF3C7", "text": "#B45309"},
    {"code": "TECH", "ru": "Наука и технологии", "az": "Elm və texnologiyalar", "en": "Science & technology", "icon": "icons/categories/technology.svg", "bg": "#F3E8FF", "text": "#7E22CE"},
    {"code": "development-support", "ru": "Развитие и поддержка", "az": "İnkişaf və dəstək", "en": "Development & support", "icon": "icons/categories/development-support.svg", "bg": "#F3F4F6", "text": "#4B5563"},
    {"code": "CAMP", "ru": "Лагеря", "az": "Düşərgələr", "en": "Camps", "icon": "icons/categories/camp.svg", "bg": "#FFF3DF", "text": "#9A6700"},
    {"code": "excursions-tours", "ru": "Экскурсии и туры", "az": "Ekskursiyalar və turlar", "en": "Excursions & tours", "icon": "icons/categories/excursions-tours.svg", "bg": "#E0F2FE", "text": "#0369A1"},
]
