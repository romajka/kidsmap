...
class _BaseSiteSettingsSectionAdmin(admin.ModelAdmin):
    ...
    @admin.display(description=_("Текущий фон шапки сайта (Header)"))
...
class SiteGalleryImageAdmin(admin.ModelAdmin):
    ...
    def changelist_view(self, request, extra_context=None):
        ...
        main_images = [
            {
                "title": _("Логотип сайта"),
                "field_name": "logo",
                "location": _("Отображается в шапке сайта (header) слева на всех страницах"),
                "size_hint": _("SVG, WebP или PNG | Размер: 256×256 px (пропорция 1:1, квадрат) | до 500 KB"),
            ...
            {
                "title": _("Фон всего сайта (ПК)"),
                "field_name": "site_background_image",
                "location": _("Декоративная фоновая подложка всего сайта для ПК"),
                "size_hint": _("JPG/WebP | Размер: 1920×1080 px (пропорция 16:9) | до 2 MB"),
                "file": get_file_info(site.site_background_image),
                "edit_url": reverse("admin:catalog_sitebrandingsettings_changelist"),
                "preview_url": reverse("home"),
            },
            {
                "title": _("Фон всего сайта (Мобильный 📱)"),
                "field_name": "site_background_mobile_image",
                "location": _("Декоративная фоновая подложка всего сайта для смартфонов (экраны <768px)"),
                "size_hint": _("JPG/WebP | Размер: 800×1400 px (пропорция ~4:7, вертикальная) | до 1 MB"),
                "file": get_file_info(site.site_background_mobile_image),
                "edit_url": reverse("admin:catalog_sitebrandingsettings_changelist"),
                "preview_url": reverse("home"),
            },
            {
                "title": _("Фон шапки сайта (Header, ПК)"),
                "field_name": "header_background_image",
                "location": _("Фоновая иллюстрация верхней навигации для ПК"),
                "size_hint": _("PNG/WebP/JPG | Размер: 1600×120 px (пропорция ~13:1, полоса) | до 500 KB"),
                "file": get_file_info(site.header_background_image),
                "edit_url": reverse("admin:catalog_sitebrandingsettings_changelist"),
                "preview_url": reverse("home"),
            },
            {
                "title": _("Фон шапки сайта (Header, Мобильный 📱)"),
                "field_name": "header_background_mobile_image",
                "location": _("Фоновая иллюстрация верхней навигации для смартфонов (экраны <768px)"),
                "size_hint": _("PNG/WebP/JPG | Размер: 800×160 px (пропорция ~5:1, узкая полоса) | до 300 KB"),
                "file": get_file_info(site.header_background_mobile_image),
                "edit_url": reverse("admin:catalog_sitebrandingsettings_changelist"),
                "preview_url": reverse("home"),
            },
            {
                "title": _("Фон hero-баннера (ПК)"),
                "field_name": "home_hero_image",
                "location": _("Фоновое изображение главного блока на странице для ПК"),
                "size_hint": _("JPG/WebP | Размер: 1600×600 px (пропорция ~8:3) | до 1 MB"),
                "file": get_file_info(site.home_hero_image),
                "edit_url": reverse("admin:catalog_sitebrandingsettings_changelist"),
                "preview_url": reverse("home"),
            },
            {
                "title": _("Фон hero-баннера (Мобильный 📱)"),
                "field_name": "home_hero_mobile_image",
                "location": _("Фоновое изображение главного блока на странице для смартфонов"),
                "size_hint": _("JPG/WebP | Размер: 800×1000 px (пропорция ~4:5, вертикальная) | до 800 KB"),
                "file": get_file_info(site.home_hero_mobile_image),
                "edit_url": reverse("admin:catalog_sitebrandingsettings_changelist"),
                "preview_url": reverse("home"),
            },
            {
                "title": _("Фон блока карты (ПК)"),
                "field_name": "home_map_image",
                "location": _("Фоновое изображение под блоком интерактивной карты для ПК"),
                "size_hint": _("JPG/WebP | Размер: 1600×600 px (пропорция ~8:3) | до 1 MB"),
            ...
            {
                "title": _("Фон блока карты (Мобильный 📱)"),
                "field_name": "home_map_mobile_image",
                "location": _("Фоновое изображение под блоком карты для смартфонов"),
                "size_hint": _("JPG/WebP | Размер: 800×900 px (пропорция ~8:9, вертикальная) | до 800 KB"),
                "file": get_file_info(site.home_map_mobile_image),
                "edit_url": reverse("admin:catalog_sitebrandingsettings_changelist"),
                "preview_url": reverse("home"),
            },
            {
                "title": _("Фон блока рекомендаций (ПК)"),
                "field_name": "home_recommended_image",
                "location": _("Фоновое изображение под рекомендуемыми местами для ПК"),
                "size_hint": _("JPG/WebP | Размер: 1600×600 px (пропорция ~8:3) | до 1 MB"),
            ...
            {
                "title": _("Фон блока рекомендаций (Мобильный 📱)"),
                "field_name": "home_recommended_mobile_image",
                "location": _("Фоновое изображение под рекомендуемыми местами для смартфонов"),
                "size_hint": _("JPG/WebP | Размер: 800×900 px (пропорция ~8:9, вертикальная) | до 800 KB"),
            ...
            {
                "title": _("Фон блока категорий (ПК)"),
                "field_name": "home_categories_image",
                "location": _("Фоновое изображение под блоком популярных категорий для ПК"),
                "size_hint": _("JPG/WebP | Размер: 1600×600 px (пропорция ~8:3) | до 1 MB"),
            ...
            {
                "title": _("Фон блока категорий (Мобильный 📱)"),
                "field_name": "home_categories_mobile_image",
                "location": _("Фоновое изображение под блоком категорий для смартфонов"),
                "size_hint": _("JPG/WebP | Размер: 800×900 px (пропорция ~8:9, вертикальная) | до 800 KB"),
            ...
            {
                "title": _("Фон блока 'Как это работает' (ПК)"),
                "field_name": "home_steps_image",
                "location": _("Фоновое изображение под шагами использования для ПК"),
                "size_hint": _("JPG/WebP | Размер: 1600×600 px (пропорция ~8:3) | до 1 MB"),
            ...
            {
                "title": _("Фон блока 'Как это работает' (Мобильный 📱)"),
                "field_name": "home_steps_mobile_image",
                "location": _("Фоновое изображение под шагами использования для смартфонов"),
                "size_hint": _("JPG/WebP | Размер: 800×900 px (пропорция ~8:9, вертикальная) | до 800 KB"),
            ...
            {
                "title": _("Фон блока преимуществ (ПК)"),
                "field_name": "home_trust_image",
                "location": _("Фоновое изображение под блоком преимуществ для ПК"),
                "size_hint": _("JPG/WebP | Размер: 1600×600 px (пропорция ~8:3) | до 1 MB"),
            ...
            {
                "title": _("Фон блока преимуществ (Мобильный 📱)"),
                "field_name": "home_trust_mobile_image",
                "location": _("Фоновое изображение под блоком преимуществ для смартфонов"),
                "size_hint": _("JPG/WebP | Размер: 800×900 px (пропорция ~8:9, вертикальная) | до 800 KB"),
            ...
            {
                "title": _("Фон нижнего призыва (CTA, ПК)"),
                "field_name": "home_cta_image",
                "location": _("Фоновое изображение под баннером FAQ/призыва для ПК"),
                "size_hint": _("JPG/WebP | Размер: 1600×500 px (пропорция ~16:5) | до 1 MB"),
                "file": get_file_info(site.home_cta_image),
                "edit_url": reverse("admin:catalog_sitebrandingsettings_changelist"),
                "preview_url": reverse("home"),
            },
            {
                "title": _("Фон нижнего призыва (CTA, Мобильный 📱)"),
                "field_name": "home_cta_mobile_image",
                "location": _("Фоновое изображение под баннером FAQ/призыва для смартфонов"),
                "size_hint": _("JPG/WebP | Размер: 800×900 px (пропорция ~8:9, вертикальная) | до 800 KB"),
            ...
            {
                "title": _("Фон подвала сайта (Footer, ПК)"),
                "field_name": "footer_background_image",
                "location": _("Фоновая иллюстрация подвала (футера) для ПК"),
                "size_hint": _("JPG/WebP | Размер: 1600×500 px (пропорция ~16:5) | до 1 MB"),
            ...
            {
                "title": _("Фон подвала сайта (Footer, Мобильный 📱)"),
                "field_name": "footer_background_mobile_image",
                "location": _("Фоновая иллюстрация подвала (футера) для смартфонов"),
                "size_hint": _("JPG/WebP | Размер: 800×1000 px (пропорция ~4:5, вертикальная) | до 800 KB"),
            ...
            {
                "title": _("Баннер каталога (ПК)"),
                "field_name": "catalog_hero_image",
                "location": _("Фоновое изображение вверху каталога для ПК"),
                "size_hint": _("JPG/WebP | Размер: 1600×500 px (пропорция ~16:5) | до 1 MB"),
            ...
            {
                "title": _("Баннер каталога (Мобильный 📱)"),
                "field_name": "catalog_hero_mobile_image",
                "location": _("Фоновое изображение вверху каталога для смартфонов"),
                "size_hint": _("JPG/WebP | Размер: 800×500 px (пропорция ~8:5) | до 600 KB"),
                "file": get_file_info(site.catalog_hero_mobile_image),
                "edit_url": reverse("admin:catalog_sitebrandingsettings_changelist"),
                "preview_url": reverse("place_list"),
            },
            {
                "title": _("Баннер страницы 'О проекте' (ПК)"),
                "field_name": "about_hero_image",
                "location": _("Фоновое изображение вверху страницы «О проекте» для ПК"),
                "size_hint": _("JPG/WebP | Размер: 1600×500 px (пропорция ~16:5) | до 1 MB"),
            ...
            {
                "title": _("Баннер страницы 'О проекте' (Мобильный 📱)"),
                "field_name": "about_hero_mobile_image",
                "location": _("Фоновое изображение вверху страницы «О проекте» для смартфонов"),
                "size_hint": _("JPG/WebP | Размер: 800×500 px (пропорция ~8:5) | до 600 KB"),
            ...
            {
                "title": _("Баннер страницы отзывов (ПК)"),
                "field_name": "reviews_hero_image",
                "location": _("Фоновое изображение страницы отзывов для ПК"),
                "size_hint": _("JPG/WebP | Размер: 1600×500 px (пропорция ~16:5) | до 1 MB"),
            ...
            {
                "title": _("Баннер страницы отзывов (Мобильный 📱)"),
                "field_name": "reviews_hero_mobile_image",
                "location": _("Фоновое изображение страницы отзывов для смартфонов"),
                "size_hint": _("JPG/WebP | Размер: 800×500 px (пропорция ~8:5) | до 600 KB"),
            ...
            {
                "title": _("Баннер страницы «Добавить место» (ПК)"),
                "field_name": "for_business_hero_image",
                "location": _("Фоновое изображение страницы «Добавить место» для ПК"),
                "size_hint": _("JPG/WebP | Размер: 1600×500 px (пропорция ~16:5) | до 1 MB"),
            ...
            {
                "title": _("Баннер страницы «Добавить место» (Мобильный 📱)"),
                "field_name": "for_business_hero_mobile_image",
                "location": _("Фоновое изображение страницы «Добавить место» для смартфонов"),
                "size_hint": _("JPG/WebP | Размер: 800×500 px (пропорция ~8:5) | до 600 KB"),
            ...
            {
                "title": _("Баннер личного кабинета (ПК)"),
                "field_name": "dashboard_hero_image",
                "location": _("Фоновое изображение шапки дашборда для ПК"),
                "size_hint": _("JPG/WebP | Размер: 1600×500 px (пропорция ~16:5) | до 1 MB"),
            ...
            {
                "title": _("Баннер личного кабинета (Мобильный 📱)"),
                "field_name": "dashboard_hero_mobile_image",
                "location": _("Фоновое изображение шапки дашборда для смартфонов"),
                "size_hint": _("JPG/WebP | Размер: 800×500 px (пропорция ~8:5) | до 600 KB"),
            ...
            {
                "title": _("Картинка пустого результата"),
                "field_name": "empty_results_image",
                "location": _("Отображается, когда ничего не найдено по поиску/фильтру"),
                "size_hint": _("PNG/WebP | Размер: 600×400 px (пропорция 3:2) | до 500 KB"),
        ...
        if hero_gallery or not partners_gallery: # Показываем hero по умолчанию, даже если пусто
            galleries.append({
                ...
                "images": hero_gallery,
                "size_hint": _("JPG, PNG или WebP до 2 MB"),
            })
        if partners_gallery:
            galleries.append({
                "title": _("Партнёры"),
                ...
                "size_hint": _("PNG или SVG с прозрачным фоном, до 500 KB"),
            })

        context = {
            **self.admin_site.each_context(request),
            "title": _("Фото для блоков сайта"),
            "opts": self.model._meta,
